												...
												<li id="carouselExampleSlidesOnly"
													...
													<ul class="carousel-inner">
														<li class="carousel-item active">
															<a title="Product 1" href="#"><?= $html->image('mega-menu/new-collection.png', ['class' => 'img-responsive', 'alt' => 'product 1']) ?></a>
														...
														<li class="carousel-item">
															<a title="Product 2" href="#"><?= $html->image('mega-menu/new-collection-2.png', ['class' => 'img-responsive', 'alt' => 'product 2']) ?></a>
														...
														<li class="carousel-item">
															<a title="Product 3" href="#"><?= $html->image('mega-menu/new-collection-3.png', ['class' => 'img-responsive', 'alt' => 'product 3']) ?></a>
		...
		<div class="container">
			<div class="row">
					...
					<div class="large-product">
						<div class="row">
							<div id="about-carousel"
								...
								<ul class="slides">
									<li>
                                        <?= $html->image('single-product/product-thumb-1.jpg', ['alt' => 'product-thumb']) ?>
									</li>
									<li>
                                        <?= $html->image('single-product/product-thumb-2.jpg', ['alt' => 'product-thumb']) ?>
									</li>
									<li>
                                        <?= $html->image('single-product/product-thumb-3.jpg', ['alt' => 'product-thumb']) ?>
									</li>
								</ul>
							</div>
							<div id="about-slider" class="col-12 col-md-12 col-lg-9 flexslider product-slider">
								<ul class="slides">
									<li>
										<a href="images/single-product/product-large-1.jpg"><?= $html->image('single-product/product-large-1.jpg', ['alt' => 'product-thumb']) ?></a>
									</li>
									<li>
										<a href="images/single-product/product-large-1.jpg"><?= $html->image('single-product/product-large-2.jpg', ['alt' => 'product-thumb']) ?></a>
									</li>
									<li>
										<a href="images/single-product/product-large-1.jpg"><?= $html->image('single-product/product-large-3.jpg', ['alt' => 'product-thumb']) ?></a>
									</li>
									<li>
										<a href="images/single-product/product-large-1.jpg"><?= $html->image('single-product/product-large-2.jpg', ['alt' => 'product-thumb']) ?></a>
									</li>
						...
						<div class="row">
							<div class="col-12 col-md-6 col-lg-6 main-product">
								<div class="category-box product-box">
									<div class="inner-product">
                                        <?= $html->image('featured/featured-2.jpg', ['alt' => 'featured-img']) ?>
							...
							<div class="col-12 col-md-6 col-lg-6 main-product">
								<div class="category-box product-box">
									...
									<div class="inner-product">
                                        <?= $html->image('featured/featured-3.jpg', ['alt' => 'featured-img']) ?>
										<div class="product-box-inner">
											<ul>
				...
				<div class="col-12 col-md-12 col-lg-5 single-product-sidebar">
					...
					<ul class="single-side-widget top-social ow-left-padding">
						<li><?= $html->image('single-product/add-banner.png', ['alt' => 'add-banner']) ?></li>
					</ul>
						...
						<div role="tabpanel">
							...
							<div class="tab-content">
								<div class="tab-pane fade show active" id="pricing" role="tabpanel"
									...
									<a title="Add Banner" href="#"><?= $html->image('add-banner-2.jpg', ['alt' => 'add-banner']) ?></a>
								</div>
									...
									<div class="shopping-cart-table size-chart">
										<div class="row">
											<div class="col-12 col-md-5 col-lg-6">
												...
												<?= $html->image('single-product/man.png', ['alt' => 'man']) ?>
											</div>
											...
											<div class="col-12 col-md-5 col-lg-6">
												...
												<?= $html->image('single-product/girls.png', ['alt' => 'girls']) ?>
											</div>
			...
			<div class="container">
				<div class="row">
					...
					<aside class="col-12 col-md-12 col-lg-3 widget widget_facebook">
						...
						<ul>
							<li><a title="Facebook photo" href="#"><?= $html->image('footer/fb-1.jpg', ['alt' => 'footer-img']) ?></a></li>
							<li><a title="Facebook photo" href="#"><?= $html->image('footer/fb-2.jpg', ['alt' => 'footer-img']) ?></a></li>
							<li><a title="Facebook photo" href="#"><?= $html->image('footer/fb-3.jpg', ['alt' => 'footer-img']) ?></a></li>
							<li><a title="Facebook photo" href="#"><?= $html->image('footer/fb-4.jpg', ['alt' => 'footer-img']) ?></a></li>
							<li><a title="Facebook photo" href="#"><?= $html->image('footer/fb-5.jpg', ['alt' => 'footer-img']) ?></a></li>
							<li><a title="Facebook photo" href="#"><?= $html->image('footer/fb-6.jpg', ['alt' => 'footer-img']) ?></a></li>
							<li><a title="Facebook photo" href="#"><?= $html->image('footer/fb-7.jpg', ['alt' => 'footer-img']) ?></a></li>
							<li><a title="Facebook photo" href="#"><?= $html->image('footer/fb-8.jpg', ['alt' => 'footer-img']) ?></a></li>
						</ul>
