...
<head>
    ...
    <?= $this->Html->css(['/vendor/fontawesome-free/css/all.min.css', 'custom', 'style', 'default.css', 'flash.css']) ?>
    <?= $this->fetch('css') ?>
    <?= $this->fetch('script') ?>
                ...
                <nav class="navbar navbar-expand-lg bg-body-tertiary navbar-static-top">
                    ...
                    <div class="collapse navbar-collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" title="Home" href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'display']) ?>">Home</a>
                            </li>
                            ...
                            <?php if ($this->Identity->isLoggedIn()) : ?>
                                ...
                                <?php if ($this->Identity->get('role') == 'admin') : ?>
                                    ...
                                    <li class="nav-item dropdown mega-dropdown">
                                        <a title="Categories" href="<?= $this->Url->build(['controller' => 'Categories', 'action' => 'index']) ?>" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                                            Categories
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" title="Contacts" href="<?= $this->Url->build(['controller' => 'Contacts', 'action' => 'index']) ?>">Contacts</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" title="Users" href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'index']) ?>">Users</a>
                                    </li>
                                <?php elseif ($this->Identity->get('role') == 'customer') : ?>
                                    <li class="nav-item">
                            ...
                            <!-- Public Links (always visible) -->
                            <li class="nav-item">
<!--                                <a class="nav-link" title="About Us" href="--><?php //= $this->Url->build(['controller' => 'Pages', 'action' => 'display', 'about']) ?><!--">About Us</a>-->
