...
<head>
    ...
    <?= $this->Html->css(['/vendor/fontawesome-free/css/all.min.css', 'custom', 'style', 'default.css']) ?>
    <?= $this->fetch('css') ?>
    <?= $this->fetch('script') ?>
				...
				<nav class="navbar navbar-expand-lg bg-body-tertiary navbar-static-top">
					...
					<div class="collapse navbar-collapse" id="navbar">
						<ul class="nav navbar-nav">
							...
							<li class="nav-item"><a class="nav-link" title="Products" href="<?= $this->Url->build(['controller' => 'Products', 'action' => 'index']) ?>">Products</a></li>
